...
type Config struct {
	...
	CherryPickedCharts []*CherryPickedChart `protobuf:"bytes,8,rep,name=cherry_picked_charts,json=cherryPickedCharts,proto3" json:"cherry_picked_charts,omitempty"`
...
func (x *Config) GetCherryPickedCharts() []*CherryPickedChart {
	if x != nil {
		return x.CherryPickedCharts
	}
	return nil
}

// CherryPickedChart represents a chart with its versions
...
func (x *CherryPickedChart) Reset() {
	*x = CherryPickedChart{}
...
func (x *CherryPickedChart) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CherryPickedChart) ProtoMessage() {}

func (x *CherryPickedChart) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CherryPickedChart.ProtoReflect.Descriptor instead.
func (*CherryPickedChart) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{1}
}

func (x *CherryPickedChart) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CherryPickedChart) GetVersions() []string {
	if x != nil {
		return x.Versions
	}
	return nil
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\x03api\"\xce\x02\n" +
	"\x06Config\x12#\n" +
	...
	"skipImages\x12H\n" +
	"\x14cherry_picked_charts\x18\b \x03(\v2\x16.api.CherryPickedChartR\x12cherryPickedCharts\"C\n" +
	"\x11CherryPickedChart\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bversions\x18\x02 \x03(\tR\bversions\"X\n" +
	"\x06Source\x12\x1d\n" +
...
var file_config_proto_goTypes = []any{
	...
	(*CherryPickedChart)(nil),        // 2: api.CherryPickedChart
	(*Source)(nil),                   // 3: api.Source
	(*Containers)(nil),               // 4: api.Containers
	(*Target)(nil),                   // 5: api.Target
	(*Repo)(nil),                     // 6: api.Repo
	(*Auth)(nil),                     // 7: api.Auth
	(*Containers_ContainerAuth)(nil), // 8: api.Containers.ContainerAuth
}
var file_config_proto_depIdxs = []int32{
	3,  // 0: api.Config.source:type_name -> api.Source
	5,  // 1: api.Config.target:type_name -> api.Target
	2,  // 2: api.Config.cherry_picked_charts:type_name -> api.CherryPickedChart
	6,  // 3: api.Source.repo:type_name -> api.Repo
	4,  // 4: api.Source.containers:type_name -> api.Containers
	8,  // 5: api.Containers.auth:type_name -> api.Containers.ContainerAuth
	6,  // 6: api.Target.repo:type_name -> api.Repo
	4,  // 7: api.Target.containers:type_name -> api.Containers
	0,  // 8: api.Repo.kind:type_name -> api.Kind
	7,  // 9: api.Repo.auth:type_name -> api.Auth
